...
namespace CognitivePrototype
{
    public partial class CognitiveForm : Form
    {
        ...
        string ArtLynxIPAdd = "192.168.127.51";
        string Moxa2IpAdd = "192.168.127.50";
        string Moxa1IpAdd = "192.168.127.52";
        ...
        void MoxaData(object sender, EventArgs e)
        {
            ...
            if (gameIsStart == true && canTap == true)
            {
