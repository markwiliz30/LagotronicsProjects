...
namespace NportPrototypeControllerForm
{
    public partial class NPortControllerConnectionForm : Form
    {
        ...
        string ConnectionName = "Encoder", IPAdd = "192.168.127.254", ConnectionName2 = "Encoder2", IPAdd2 = "192.168.127.253", btnConnectName = "ioLogik1210", btnIpAdd = "192.168.127.50";
        public NPortControllerConnectionForm(MagicStoneKingdomDeviceControlManager magicStoneKingdomDeviceControlManager)
        {
            InitializeComponent();
            this.magicStoneKingdomDeviceControlManager_2 = magicStoneKingdomDeviceControlManager;
            this.magicStoneKingdomDeviceControlManager_1 = magicStoneKingdomDeviceControlManager;
            this.magicStoneKingdomDeviceControlManager_btn_1 = magicStoneKingdomDeviceControlManager;
        ...
        private void buttonConnect_Click(object sender, EventArgs e)
        {
            ...
            {
                Controller_1 = magicStoneKingdomDeviceControlManager_1.GetNPortSerialDeviceServerController(textBoxName.Text);
